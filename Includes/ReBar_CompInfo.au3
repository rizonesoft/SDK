...
If Not IsDeclared("$iEventError") Then
	Global $iEventError = False
EndIf
...
Func _ComputerGetSoftware(ByRef $aSoftwareInfo)
	...
	While 1
		Local $AppKey	= RegEnumKey($UnInstKey, $i)
...
Func _ComputerGetSystemProduct(ByRef $aSysProductInfo)
	...
	If Not $iEventError Then
		...
		If IsObj($colItems) Then
			For $objItem In $colItems
				ReDim $aSysProductInfo[UBound($aSysProductInfo) + 1][8]
				$aSysProductInfo[$i][0]  = $objItem.Caption
				$aSysProductInfo[$i][1]  = $objItem.Description
				$aSysProductInfo[$i][2]  = $objItem.IdentifyingNumber
				$aSysProductInfo[$i][3]  = $objItem.Name
				$aSysProductInfo[$i][4]  = $objItem.SKUNumber
				$aSysProductInfo[$i][5]  = $objItem.UUID
				$aSysProductInfo[$i][6]  = $objItem.Vendor
				$aSysProductInfo[$i][7]  = $objItem.Version
				$i += 1
			Next

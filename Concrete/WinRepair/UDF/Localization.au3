...
Global Const $LNG_COUNTREPAIR = 100
; ===============================================================================================================================
...
Func _Localization_Repair()
	...
	$g_aLangRepair[25] = _Localization_ReplaceVar(IniRead($g_sLanguageFile, "Repair", "Internet.01", "Reset Internet Protocols (TCP/IP)|High|Static IP configuration may be lost!"))
	$g_aLangRepair[26] = _Localization_ReplaceVar(IniRead($g_sLanguageFile, "Repair", "Internet.02", "Repair Winsock (Reset Catalog)|Moderate|Any pre-installed LSP's will need to be reinstalled."))
	$g_aLangRepair[27] = _Localization_ReplaceVar(IniRead($g_sLanguageFile, "Repair", "Internet.03", "Renew Internet Connections|Low"))
	$g_aLangRepair[28] = _Localization_ReplaceVar(IniRead($g_sLanguageFile, "Repair", "Internet.04", "Flush DNS Resolver Cache (Domain Name System)|None"))
	$g_aLangRepair[29] = _Localization_ReplaceVar(IniRead($g_sLanguageFile, "Repair", "Internet.05", "Flush ARP Cache (Address Resolution Protocol)"))
	$g_aLangRepair[30] = _Localization_ReplaceVar(IniRead($g_sLanguageFile, "Repair", "Internet.06", "Repair Internet Explorer %s"))
	$g_aLangRepair[31] = _Localization_ReplaceVar(IniRead($g_sLanguageFile, "Repair", "Internet.07", "Clear Windows Update History"))
	$g_aLangRepair[32] = _Localization_ReplaceVar(IniRead($g_sLanguageFile, "Repair", "Internet.08", "Repair Windows / Automatic Updates"))
	$g_aLangRepair[33] = _Localization_ReplaceVar(IniRead($g_sLanguageFile, "Repair", "Internet.09", "Repair SSL / HTTPS / Cryptography"))
	$g_aLangRepair[34] = _Localization_ReplaceVar(IniRead($g_sLanguageFile, "Repair", "Internet.10", "Reset Proxy Server Configuration"))
	$g_aLangRepair[35] = _Localization_ReplaceVar(IniRead($g_sLanguageFile, "Repair", "Internet.11", "Reset Windows Firewall Configuration"))
	$g_aLangRepair[36] = _Localization_ReplaceVar(IniRead($g_sLanguageFile, "Repair", "Internet.12", "Restore the default hosts file"))
	$g_aLangRepair[37] = _Localization_ReplaceVar(IniRead($g_sLanguageFile, "Repair", "Internet.13", "Renew Wins Client Registrations"))

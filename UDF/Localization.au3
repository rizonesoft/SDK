...
Func _Localization_Custom()
	...
	$g_aLangCustom[12] = _Localization_ReplaceVar(IniRead($g_sLanguageFile, "Custom", "Commands.13", "Create Source Code Package"))
	$g_aLangCustom[13] = _Localization_ReplaceVar(IniRead($g_sLanguageFile, "Custom", "Commands.14", "Create Update File"))
	$g_aLangCustom[14] = _Localization_ReplaceVar(IniRead($g_sLanguageFile, "Custom", "Build", "Build"))
	$g_aLangCustom[15] = _Localization_ReplaceVar(IniRead($g_sLanguageFile, "Custom", "Distribution", "Distribution"))
	$g_aLangCustom[16] = _Localization_ReplaceVar(IniRead($g_sLanguageFile, "Custom", "Button.Process", "Process"))
	$g_aLangCustom[17] = _Localization_ReplaceVar(IniRead($g_sLanguageFile, "Custom", "Tab.Logging", "Logging"))
